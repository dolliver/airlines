...
public  class FarePricesResponse {
    ...
    @JsonCreator
    public FarePricesResponse(@JsonProperty("first") PriceResponse first, @JsonProperty("business") PriceResponse business, @JsonProperty("economy") PriceResponse economy){
        this.first = first;
