...
public class PriceResponse {
  ...
  @JsonCreator
  public PriceResponse(@JsonProperty("ticket") MoneyAmountResponse ticket,
      @JsonProperty("bookingFee") MoneyAmountResponse bookingFee, @JsonProperty("tax") MoneyAmountResponse tax) {
    this.ticket = ticket;
