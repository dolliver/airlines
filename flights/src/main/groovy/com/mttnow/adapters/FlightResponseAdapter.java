...
public class FlightResponseAdapter {
	  ...
	  public FlightResponse toEntity(final Flight flight) {
		  ...
		  FlightResponse response = new FlightResponse(flight.getCarrierCode(), flight.getFlightDesignator(), flight.getOriginAirport(), flight.getDestinationAirport(), departsOn, arrivesOn, flightTime, farePrices);
				  
		  return response;
	 }

	private String calculateFlightDuration(XMLGregorianCalendar departureDate,
